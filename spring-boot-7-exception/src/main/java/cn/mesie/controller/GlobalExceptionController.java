...
/**
 * Created by 2019-04-14 23:39
 *
 * @author: mesie
 */

import cn.mesie.exception.ErrorMassage;
import cn.mesie.exception.MineException;
...
public class GlobalExceptionController {
    ...
    public ErrorMassage<Object> ErrorHandler(HttpServletRequest req, MineException e) throws Exception {
        ErrorMassage<Object> error = new ErrorMassage<Object>();
        error.setCode(404);
