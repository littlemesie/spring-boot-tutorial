...
// ==========================================================匹配切点表达式========================================================================================
    ...
    // 匹配 OR、AND
    @Pointcut(value = "execution(* cn.mesie.service.*.add*(int))")
    public void log7() {
    }

    // 匹配 OR、AND、
    @Pointcut(value = "execution(* cn.mesie.service.*.add*(int)) OR execution(* cn.timebusker..add*(String))")
    public void log8() {
    }
     ...
     */
    // 匹配指定类型内的方法执行--只能匹配类型
    @Pointcut(value = "within(cn.mesie.service.order.impl.OrderServiceImpl)")
    public void logw1() {
    }

    // 匹配指定类型内的方法执行(包下所有的类)
    @Pointcut(value = "within(cn.mesie.service.order.impl.*)")
    public void logw2() {
    }
     ...
     */
    // 匹配指定类型内的方法执行(包下所有的类)
    @Pointcut(value = "this(cn.mesie.service.order.OrderService)")
    public void logt1() {
    }
     ...
     */
    // 匹配指定类型内的方法执行(包下所有的类)
    @Pointcut(value = "target(cn.mesie.service.order.OrderService)")
    public void logt2() {
    }
 ...
 */
    ...
    @Pointcut(value = "@within(cn.mesie.annotation.timebuskerBean)")
    public void logaw2() {
    }
 ...
 */
    ...
    @Pointcut(value = "@annotation(cn.mesie.annotation.timebuskerMethod)")
    public void logaa1() {
    }
